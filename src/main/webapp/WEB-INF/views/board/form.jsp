...
<div class="container">
	<div class="row mb-3">
		<div class="col-12">
			...
			<form onsubmit="checkBoardform(event)" class="border bg-light p-3" method="post" action="insert.do">
				...
				<div class="text-end">
					<a href="list.do" class="btn btn-primary">취소</a>
